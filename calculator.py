...
def add(*args):
    ...
    try:
        addi = sum(map(int, args))
    except ValueError:
        addi = 'Please put some numbers'
...
def divide(*args):
    try:
        ...
        div = 'Please put some numbers'
    except ZeroDivisionError:
        div = 'Division per 0 is impossible'
    return div
